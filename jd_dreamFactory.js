...
async function joinLeaderTuan() {
  ...
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/1994112/updateTeam1@master/shareCodes/jd_updateFactoryTuanId.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await updateTuanIdsCDN('https://cdn.jsdelivr.net/gh/1994112/updateTeam1@master/shareCodes/jd_updateFactoryTuanId.json');
  }
