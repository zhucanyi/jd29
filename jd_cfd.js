...
!(async () => {
  ...
  if (new Date().getHours() <= 3) res = await getAuthorShareCode('https://raw.githubusercontent.com/1994112/updateTeam1/master/shareCodes/cfd.json');
  if (!res2) res2 = await getAuthorShareCode('https://raw.githubusercontent.com/1994112/updateTeam1/master/shareCodes/cfd.json')
